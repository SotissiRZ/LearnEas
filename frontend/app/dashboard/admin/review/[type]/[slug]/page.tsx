            ...
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div className="max-w-3xl">
                <div className="mb-3 flex flex-wrap items-center gap-2">
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-400/15 px-3 py-1 text-xs font-semibold text-emerald-200"><ShieldCheck size={14} /> Vérification administrateur</span>
                  <span className={`rounded-full px-3 py-1 text-xs font-semibold ${resource.published ? "bg-white/10 text-white" : "bg-amber-400/15 text-amber-200"}`}>{resource.published ? "Publié" : "Non publié"}</span>
                </div>
