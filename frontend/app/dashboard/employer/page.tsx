...
export default function EmployerDashboardPage() {
  ...
  return <div className="container-app py-10">
    <div className="mb-8 flex flex-wrap items-end justify-between gap-3"><div><p className="text-xs font-bold uppercase tracking-widest text-brand-600">LearnEas Talent</p><h1 className="mt-1 text-2xl font-extrabold">Espace recruteur</h1><p className="mt-1 text-sm text-gray-500">Publiez des opportunités, évaluez des candidatures vérifiées et découvrez des talents.</p></div><div className="flex gap-2"><Link href="/opportunities" className="btn-outline"><ExternalLink size={14}/> Voir le marché</Link>{profile.status === "approved" && <button onClick={() => setShowCreate(true)} className="btn-primary"><Plus size={15}/> Nouvelle opportunité</button>}</div></div>
