...
export default function InstructorStudentsPage() {
  ...
  return <div className="min-w-0">
    ...
    <div className="card mb-4 flex flex-wrap gap-3 p-4">
      <div className="relative w-full flex-1 sm:min-w-[220px]"><Search size={15} className="absolute left-3 top-2.5 text-gray-400" /><input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Rechercher un étudiant ou un contenu" className="w-full rounded-lg border border-gray-200 py-2 pl-9 pr-3 text-sm" /></div>
