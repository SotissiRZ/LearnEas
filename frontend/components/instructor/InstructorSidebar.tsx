...
export default function InstructorSidebar() {
  ...
  return (
    <aside className="peer group sticky top-[72px] z-30 self-start bg-white py-2 lg:absolute lg:inset-y-0 lg:left-0 lg:top-0 lg:z-50 lg:h-full lg:w-16 lg:overflow-hidden lg:bg-navy-950 lg:py-0 lg:shadow-sm lg:transition-[width] lg:duration-200 lg:ease-out lg:hover:w-60">
      <div className="card overflow-hidden lg:flex lg:h-full lg:min-h-0 lg:flex-col lg:rounded-none lg:border-y-0 lg:border-l-0 lg:border-r lg:border-white/10 lg:bg-navy-950 lg:text-white lg:shadow-none">
        <div className="border-b border-slate-100 lg:border-white/10 px-4 py-4 lg:flex lg:h-[70px] lg:shrink-0 lg:items-center lg:px-3">
          <div className="flex items-center gap-3 font-bold text-ink lg:text-white lg:w-full lg:min-w-0">
            <span className="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-brand-50 text-brand-700 lg:bg-brand-500/20 lg:text-brand-300 lg:mx-auto lg:transition-all lg:duration-200 lg:group-hover:mx-0">
            ...
            <div className="min-w-0 lg:max-w-0 lg:overflow-hidden lg:whitespace-nowrap lg:opacity-0 lg:transition-all lg:duration-200 lg:group-hover:max-w-[170px] lg:group-hover:opacity-100">
              ...
              <p className="text-[11px] font-normal text-slate-400">Création, suivi et revenus</p>
            </div>
          </div>
        </div>
            ...
            return (
              <Link
                ...
                className={`flex shrink-0 items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors lg:h-10 lg:w-full lg:justify-center lg:px-0 lg:group-hover:justify-start lg:group-hover:px-3 ${
                  active ? "bg-brand-50 text-brand-700 lg:bg-brand-500/20 lg:text-brand-300" : "text-slate-600 hover:bg-slate-50 hover:text-ink lg:text-white/60 lg:hover:bg-white/10 lg:hover:text-white"
                }`}
              >
