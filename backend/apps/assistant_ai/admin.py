...
from .models import AISettings, AIConversation, AIMessage, AIKnowledgeChunk, AIUsage
...
class AISettingsAdmin(admin.ModelAdmin):
    fieldsets = (
        ...
        ("Modèle", {"fields": ("default_model", "temperature", "max_output_tokens", "max_history_messages", "max_context_chunks")}),
...
class AIUsageAdmin(admin.ModelAdmin):
    list_display = ("user", "provider", "model", "prompt_tokens", "completion_tokens", "rag_chunks", "latency_ms", "created_at")
